...
EngramSetting = BaseChainSetting(
    NETWORK_NAME=ENGRAM, GENESIS_FORK_VERSION=bytes.fromhex('10000130'),
    GENESIS_VALIDATORS_ROOT=bytes.fromhex('3cf4bd6a29344f8ccf75f629c5615f6fb85ad250063134a18a3aebf1247f9444'))
